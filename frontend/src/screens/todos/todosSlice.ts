...
const todosSlice = createSlice({
  ...
  reducers: {
    ...
    getTodosFailed(state, action: PayloadAction<string | undefined>) {
      state.isLoading = false
    ...
    deleteTodoFailed(state, action: PayloadAction<string | undefined>) {
      state.isLoading = false
      state.error = action.payload
    },
    ...
    createTodoFailed(state, action: PayloadAction<string | undefined>) {
      state.isLoading = false
      state.error = action.payload
    },
    ...
    updateTodoFailed(state, action: PayloadAction<string | undefined>) {
      state.isLoading = false
      state.error = action.payload
    },
  },
